...
public class RCC_CarControllerV3 : RCC_Core {
	...
	public float maxEngineTorque = 100f;						// Maximum engine torque at target RPM.
	public float maxEngineTorqueAtRPM = 1000f;			//	Maximum peek of the engine at this RPM.
	public float minEngineRPM = 150f;							// Minimum engine RPM.
	public float maxEngineRPM = 1000f;							// Maximum engine RPM.
