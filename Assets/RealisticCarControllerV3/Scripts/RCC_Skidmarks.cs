...
public class RCC_Skidmarks : MonoBehaviour {
	...
	public int maxMarks = 128;			// Maximum number of marks total handled by one instance of the script.
	public float markWidth = .11f;		// The width of the skidmarks. Should match the width of the wheel that it is used for. In meters.
